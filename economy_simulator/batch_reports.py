...
def _rename_firm_audit_export(frame: pd.DataFrame) -> pd.DataFrame:
    ...
    renamed = renamed.rename(
        columns={
            ...
            "rd_investment_spending": "Gasto I+D intangible",
            ...
            "cash": "Caja final firma deposito bancario",
            "period_total_spending_outflow": "Gasto total periodo incluyendo inversion",
            "firm_period_marginal_propensity_to_spend": "Propension marginal firma a gastar periodo",
            "firm_period_propensity_to_bank_deposit": "Propension firma a caer en banco periodo",
            "household_consumption_revenue": "Ingreso desde hogares consumo final",
            "firm_capital_goods_revenue": "Ingreso desde firmas bienes industriales",
            "firm_operating_procurement_revenue": "Ingreso desde firmas insumos procurement",
            "government_procurement_revenue": "Ingreso desde Estado compras publicas",
            "government_infrastructure_revenue": "Ingreso desde Estado infraestructura",
            "same_sector_revenue": "Ingreso desde mismo sector",
            "other_indirect_revenue": "Ingreso indirecto otros canales",
            "revenue_source_total": "Ingreso clasificado por fuente total",
            "unclassified_revenue": "Ingreso no clasificado residual",
            "revenue_source_overtrace": "Ingreso sobretrazado por timing",
            "revenue_source_reconciliation_gap": "Brecha reconciliacion fuente ingreso",
            "payroll_total": "Nomina total periodo",
            "payroll_tax_total": "Impuesto nomina periodo",
            "input_cost_total": "Costo insumos periodo",
            "transport_cost_total": "Costo transporte periodo",
            "fixed_overhead_total": "Costo fijo overhead periodo",
            "capital_depreciation_cost": "Costo depreciacion capital periodo",
            "inventory_carry_cost": "Costo mantenimiento inventario periodo",
            "inventory_waste_cost": "Costo merma inventario periodo",
            "interest_cost": "Costo intereses periodo",
            "severance_total": "Liquidacion despidos periodo",
            "cost_residual_unexplained": "Costo residual no explicado",
    ...
    ordered_columns = [
        ...
        "Caja final firma deposito bancario",
        "Gasto total periodo incluyendo inversion",
        "Propension marginal firma a gastar periodo",
        "Propension firma a caer en banco periodo",
        "Ingreso desde hogares consumo final",
        "Ingreso desde firmas bienes industriales",
        "Ingreso desde firmas insumos procurement",
        "Ingreso desde Estado compras publicas",
        "Ingreso desde Estado infraestructura",
        "Ingreso desde mismo sector",
        "Ingreso indirecto otros canales",
        "Ingreso clasificado por fuente total",
        "Ingreso no clasificado residual",
        "Ingreso sobretrazado por timing",
        "Brecha reconciliacion fuente ingreso",
        "Nomina total periodo",
        "Impuesto nomina periodo",
        "Costo insumos periodo",
        "Costo transporte periodo",
        "Costo fijo overhead periodo",
        "Costo depreciacion capital periodo",
        "Costo mantenimiento inventario periodo",
        "Costo merma inventario periodo",
        "Costo intereses periodo",
        "Liquidacion despidos periodo",
        "Costo residual no explicado",
        "Costo total periodo",
